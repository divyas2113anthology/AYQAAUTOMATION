...
public class WC_SearchforRecommender_Verify extends CommonSeleniumActions implements OR{
	...
	try {
		...
		if (!pagename.equals("")) {
			...
			waitForElementPresentWebdriver(attributeName_xpath, Rec_PageName, pagename);
			verifyElementContainsTextWebdriver(attributeName_xpath, Rec_PageName, pagename, pagename);
		}
		if (!verifyui.equals("")) {
