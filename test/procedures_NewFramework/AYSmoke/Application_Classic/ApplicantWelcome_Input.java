    ...
    public void ApplicantWelcome_Input() throws Exception {
        try {
            ...
            if (!applicantsection.equals("")) {
                if (!applicantsection.equalsIgnoreCase("")) {
                    ...
                    waitForPageToLoadWebdriver();
                } else if (applicantsection.equalsIgnoreCase("Family")) { //Add this code for this 23767 by saran kumar
//                    waitForPageToLoadWebdriver();
//                    switchToDefaultContentWebdriver();
//                    waitForElementPresentWebdriverWait(attributeName_xpath, Section + applicantsection + "')]", applicantsection);
//                    clickWebdriver(attributeName_xpath, Section + applicantsection + "')]");
//                    //click(Section+applicantsection+"')]");
//                    waitForPageToLoadWebdriver();
//                    sendKeys(attributeName_xpath, "//input[@id=\"q25429\"]", "Test");
//                    clickWebdriver(attributeName_xpath, "(//img[@alt='Save'])[1]");
//                    clickWebdriver(attributeName_xpath, " //font[contains(text(),'Personal Data')]");
             }
