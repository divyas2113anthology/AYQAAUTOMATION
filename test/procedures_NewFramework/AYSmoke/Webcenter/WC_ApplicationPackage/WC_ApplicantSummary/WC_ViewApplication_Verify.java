...
public class WC_ViewApplication_Verify extends CommonSeleniumActions implements OR {
	

	@Test(description="This Procedure is to perform some Verification in 'Applicant Summary' page")
		public void WC_ViewApplication_Verify() throws Exception{
		try {
			writeDetails();
...
//			writeParametersTable();
			...
			if (!pagename.equals("")) {
				...
				waitForElementPresentWebdriver(attributeName_xpath, AS_ViewApplication, pagename);
				verifyElementPresentWebdriver(attributeName_xpath, AS_ViewApplication, pagename);
