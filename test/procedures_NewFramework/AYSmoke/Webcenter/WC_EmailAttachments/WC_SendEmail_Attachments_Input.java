package procedures_NewFramework.AYSmoke.Webcenter.WC_EmailAttachments;
...
/**
 * Created by Indium on 1/2/2017.
 */

public class WC_SendEmail_Attachments_Input extends CommonSeleniumActions implements OR {

    @Test(description="This Procedure is used to perform some operation in 'Send Email with Attachments' page")

    public void WC_SendEmail_Attachments_Input(){
        try {
            writeDetails();
            Reporter.log("Proceed to retrieve Input Test Data for 'Send Email with Attachments' Page");
