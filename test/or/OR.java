...
public static final String BR_Save = "//img[@name='imageSave1']" ;//img[@name='imageAdd1']"//img[@name='imageAdd1']
...
public static final String AS_VerifyApplicationFee = "//li[contains(text(),'AppFeeStatus')]";
...
public static final String AS_TestScoreEnglish = "//input[@name='English']";
