...
//				}			
				...
				verifyElementText("//td[@class='BasePageFont']", fpmessage, "System Message:");
			}
			if (!successmessage.equals("")) {
				...
				verifyElementText("//font[@class='BasePageFont']", successmessage, "Forgot Password Reset Message");
			}
