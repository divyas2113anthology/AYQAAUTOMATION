    ...
    public void WC_SearchforEvents_Input() {
        try {
            ...
            if (!searcheventdatequery.equals("")) {
                ...
                clickWebdriver(attributeName_xpath, "//input[@id='SearchByEvent']"); // xpath change by saran kumar july 13 2023
                clickWebdriver(attributeName_xpath, "(//input[@alt='submit'])[1]");//		xpath change by saran kumar july 13 2023
                // clickWebdriver(attributeName_xpath,"(//input[@alt='submit'])[1]");
