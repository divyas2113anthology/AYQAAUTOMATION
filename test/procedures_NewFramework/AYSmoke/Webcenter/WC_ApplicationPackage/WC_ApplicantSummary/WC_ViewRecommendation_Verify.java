...
public class WC_ViewRecommendation_Verify extends CommonSeleniumActions implements OR {
	

	@Test(description="This Procedure is to perform some Verification in 'Applicant Summary' page")
		public void WC_ViewRecommendation_Verify() throws Exception{
		try {
			writeDetails();
...
//			writeParametersTable();
			...
			if (!pagename.equals("")) {
				...
				waitForElementPresentWebdriver(attributeName_xpath, AS_ViewRecommendation, pagename);
				verifyElementPresentWebdriver(attributeName_xpath, AS_ViewRecommendation, pagename);
