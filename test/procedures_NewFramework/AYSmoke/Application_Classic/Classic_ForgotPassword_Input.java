...
public class Classic_ForgotPassword_Input extends CommonSeleniumActions implements OR {

    @Test(description="This Procedure is to perform some Operation in 'Forgot Password' page")
    public void Classic_ForgotPassword_Input() throws Exception{
        try {
            writeDetails();
...
//			writeParametersTable();
            ...
            if (!fpsearch.equals("")) {
                ...
                if (fpsearch.equalsIgnoreCase("search")) {
                    waitForPageToLoadWebdriver();
                    waitForElementPresentWebdriver(attributeName_xpath,Clas_FRP_Search, "Submit Button Present");
                    clickWebdriver(attributeName_xpath,Clas_FRP_Search);
