...
public class WC_ViewEvents_Verify extends CommonSeleniumActions implements OR {
	

	@Test(description="This Procedure is to perform some Verification in 'Applicant Summary' page")
		public void WC_ViewEvents_Verify() throws Exception{
		try {
			writeDetails();
...
//			writeParametersTable();
			...
			if (!pagename.equals("")) {
				...
				waitForElementPresentWebdriver(attributeName_xpath, AS_ViewEvents, pagename);
				verifyElementPresentWebdriver(attributeName_xpath, AS_ViewEvents, pagename);
