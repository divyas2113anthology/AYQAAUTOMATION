...
public class MC_ImportFileTransfertoServer extends CommonSeleniumActions implements OR {
	
	@Test(description="This Procedure is used to perform some operation in 'FileZilla' page")
	public void MC_ImportFileTransfertoServer(){
		try {
			writeDetails();
...
//			writeFailure("Given Test Data["+yesno+"] either Incorrect or has not be Scripted ");
			if (!browserfilelocation.equals("")) {
				...
				Runtime.getRuntime().exec("C:/SeleniumScripts/AYQAAutomation/AutoIT/Filezilla/ImportFileTransfertoServer.exe \""+browserfilelocation+"\"");
